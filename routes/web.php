...
$router->post('/provider', ['uses' => 'ProviderController@createProvider', 'as' => 'provider.create', 'middleware' => 'admin']); // admin // todo
$router->get('/provider/{provider}', ['uses' => 'ProviderController@getProvider', 'as' => 'provider.get']);
$router->post('/provider/{provider}', ['uses' => 'ProviderController@updateProvider', 'as' => 'provider.edit', 'middleware' => 'admin']); // admin // todo
$router->delete('/provider/{provider}', ['uses' => 'ProviderController@deleteProvider', 'as' => 'provider.delete', 'middleware' => 'admin']); // admin // todo

// Pad
$router->get('/pad', ['uses' => 'PadController@getPads', 'as' => 'pad.list']); // todo
$router->post('/pad', ['uses' => 'PadController@createPad', 'as' => 'pad.create', 'middleware' => 'admin']); // admin // todo
$router->get('/pad/{pad}', ['uses' => 'PadController@getPad', 'as' => 'pad.get']); // todo
$router->post('/pad/{pad}', ['uses' => 'PadController@updatePad', 'as' => 'pad.edit', 'middleware' => 'admin']); // admin // todo
$router->delete('/pad/{pad}', ['uses' => 'PadController@deletePad', 'as' => 'pad.delete', 'middleware' => 'admin']); // admin // todo
